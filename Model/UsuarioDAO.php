...
class UsuarioDAO extends DB {
    ...
    public function insert(Usuario $u) {
        ...
        $sql = 'INSERT usuarios(nome, email, senha, status)  VALUES ("' . $u->getNome() . '","' . $u->getEmail() . '","' . $u->getSenha() . '",' . $u->getStatus() . ')';
    ...
    public function update(Usuario $u) {
        $sql = 'UPDATE usuarios SET nome = "' . $u->getNome() . '", email = "' . $u->getEmail() . '", senha = "' . $u->getSenha() . '",status = ' . $u->getStatus() . ' WHERE id = ' . $u->getId();
    ...
    public function getUser(Usuario $u) {
        $sql = 'SELECT * FROM usuarios WHERE email = "' . $u->getEmail() . '" AND senha = "' . $u->getSenha() . '"';
